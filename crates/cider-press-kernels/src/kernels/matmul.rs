...
//! register-blocked; we deliberately skip that complexity for now (the
//! real matmul story — qmv/qmm and the fused steel SDPA — lives in
//! `docs/inference/quantized-matmul.md`). SDPA shapes (Q @ K^T and attn @ V at Qwen2.5-0.5B
...
/// 32-wide SIMD width. Tuning is deferred (see `docs/inference/quantized-matmul.md`).
const TG_M: usize = 8;
const TG_N: usize = 8;
